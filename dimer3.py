...
# 顶部布局
col1, col2, col3 = st.columns([1, 3, 6])  # 分为三列
...
with col1:
    ...
    st.markdown("<h1 style='font-size: 24px;'>Dimer Analysis</h1>", unsafe_allow_html=True)
    st.markdown("<h5 style='font-size: 14px;'>Incobiosystem</h5>", unsafe_allow_html=True)
